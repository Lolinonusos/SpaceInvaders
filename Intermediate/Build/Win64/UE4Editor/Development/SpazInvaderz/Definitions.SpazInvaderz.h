...
#define UE_PROJECT_NAME SpazInvaderz
#define UE_TARGET_NAME SpazInvaderzEditor
#define UE_MODULE_NAME "SpazInvaderz"
...
#define SPAZINVADERZ_API DLLEXPORT
